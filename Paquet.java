...
public class Paquet {
    ...
    public void creerCartes() {
        ...
        Equipement chaussettesMcdo = new Equipement("Chaussettes Mcdo", 3, "chassure", "", 50);
        ...
        Equipement cheveuxGras = new Equipement("Cheveux gras", 5, "chapeau", "Informatique", 20); //faire INFO
